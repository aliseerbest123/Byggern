...
void menu_init()
{
	struct node *play_ping, *high_scores, *options, *randome, *easy, *medium, *hard, *play_pong, *invert, *easy_pong, *medium_pong, *hard_pong, *High_Score_pong;
