...
uint8_t can_send(CAN_MESSAGE* can_msg, uint8_t tx_mb_id)
{
	...
	printf("CAN_MSR : %d",CAN0->CAN_MB[tx_mb_id].CAN_MSR);
	printf(" MRDY : %d", CAN_MSR_MRDY);
